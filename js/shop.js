...
window.NexraShopEngine = (function () {
    ...
    function _loadPromoBanners() {
        ...
        window.db.collection('banners')
            ...
            .then(function (snap) {
                ...
                var bannerArr = [];
                snap.forEach(function (doc) { bannerArr.push(doc.data()); });
                bannerArr.sort((a, b) => (a.sortOrder || 0) - (b.sortOrder || 0));
                var html = '';
                bannerArr.slice(0, 6).forEach(function (b) {
    ...
    function _loadProducts(append) {
        ...
        var q = window.db.collection('products');
