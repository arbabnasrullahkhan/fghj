...
window.NexraBrand = {
    ...
    getAsset: function(type) {
        ...
        'beta': {
            logo: '/assets/beta-logo.png',
            favicon: '/assets/beta-logo.png',
            themeColor: '#3b82f6',
            appName: 'Nexra Tech PK',
            siteTitle: 'Nexra Tech PK | Premium Digital Assets'
        }
    ...
    // Allows seasonal overrides from Firebase (e.g., Eid theme)
    festivalMode: { active: false, themeColor: null, logoUrl: null },
    
    getAsset(type) {
        if (this.festivalMode.active && this.festivalMode.logoUrl && (type === 'logo' || type === 'favicon')) {
            return this.festivalMode.logoUrl;
        }
        return this.assets[this.activeEdition][type];
    },
